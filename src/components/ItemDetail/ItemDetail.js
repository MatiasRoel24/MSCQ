        ...
        <div key={product.id}>
            ...
            <div className="contenedor__itemdetail">
                ...
                <div className='idetail__info'>
                    ...
                    <h2 className="idetail__price">El precio es: <span className='idetail__precio--span'>${product.precio}</span> </h2>
                    <h2 className="idetail__stock">Pasajes disponibles: {product.stock}</h2>
                    {isItemCount ? 
